    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 py-5'>
        <h3 className='card-title align-items-start flex-column'>
          <span className='card-label fw-bolder fs-3 mb-1'>Transações</span>

          <span className='text-muted fw-bold fs-7'>Volume atual de transações</span>
        </h3>
        ...
        <div className='card-p pt-5 bg-white flex-grow-1'>
          ...
          <div className='row g-0'>
            ...
            <div className='col mr-8'>
              {/* begin::Label */}
              <div className='fs-7 text-muted fw-bold'>PIX</div>
              {/* end::Label */}

              {/* begin::Stat */}
              <div className='d-flex align-items-center'>
                <div className='fs-4 fw-bolder text-primary'>R$ 85.000.000</div>
                <div className={`d-flex align-items-center w-50px h-15px bg-${bgColor} rounded`}>
                  {/* begin::Icon */}
            ...
            <div className='col mr-8'>
              {/* begin::Label */}
              <div className='fs-7 text-muted fw-bold'>TED</div>
              {/* end::Label */}

              {/* begin::Stat */}
              <div className='d-flex align-items-center'>
                <div className='fs-4 fw-bolder text-primary'>R$ 65.000.000</div>
                <div className={`d-flex align-items-center w-50px h-15px bg-${bgColor} rounded`}>
                  {/* begin::Icon */}
                  <span className='svg-icon '>
                    <KTSVG
            ...
            <div className='col mr-8'>
              {/* begin::Label */}
              <div className='fs-7 text-muted fw-bold'>P2P</div>
              {/* end::Label */}

              {/* begin::Stat */}
              <div className='d-flex align-items-center'>
                <div className='fs-4 fw-bolder text-primary'>R$ 25.000.000</div>
                {/* <KTSVG
